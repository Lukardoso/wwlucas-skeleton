    ...
    return (
        <div className="h-screen grid grid-cols-[280px_1fr] pr-4 overflow-hidden">
            ...
            <div className="h-full">
                ...
                <div className="h-[85vh] mt-8 overflow-auto">{children}</div>
            </div>
        </div>
    );
}
    ...
    return (
        <div className="h-screen pt-4 pl-4 pr-12 grid grid-rows-[auto_1fr_auto] bg-linear-to-r from-white overflow-hidden">
            ...
            <div className="relative py-4">
                <div className="absolute left-0 bottom-full w-full h-16 bg-linear-to-tr from-neutral-50 pointer-events-none"></div>
                <ProfileMenu inline />
            </div>
        </div>
    );
